...
test.describe("Monitor Form", () => {
    ...
    test("successful condition", async ({ page }, testInfo) => {
        ...
        await expect(page.getByTestId("monitor-status")).toHaveText("up", { ignoreCase: true, timeout: 10000 });
    ...
    test("failing condition", async ({ page }, testInfo) => {
        ...
        await expect(page.getByTestId("monitor-status")).toHaveText("down", { ignoreCase: true, timeout: 10000 });
